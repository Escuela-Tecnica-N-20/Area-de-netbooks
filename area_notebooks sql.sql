...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-11-2024 a las 20:47:14
...
INSERT INTO `prestamos` (`Prestamo_ID`, `Netbook_ID`, `Fecha_Prestamo`, `Fecha_Devolucion`, `Curso`, `Alumno`, `Tutor`) VALUES
(1, 'B12', '2024-11-05 15:00:27', '2024-11-07 15:00:27', '44', 'Alumno', 'Tutor');
...
--
ALTER TABLE `prestamos`
  MODIFY `Prestamo_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
